...
export default function SubmittedPage() {
  ...
  return (
    <main className="relative z-0 flex min-h-screen items-center justify-center bg-black px-6 pt-24">
          ...
          <div className="mt-6 space-y-6">
            ...
            <div className="flex gap-4">
              ...
              <div>
                ...
                <p className="mt-1 text-sm text-white/40">Our AI is crafting your cinematic story</p>
              </div>
            </div>
            ...
            <div className="flex gap-4">
              ...
              <div>
                ...
                <p className="mt-1 text-sm text-white/40">Receive your HD film by email in under 1 hour {email ? `to ${email}` : ''}</p>
              </div>
            </div>
          </div>
        </div>

        <div className="mt-10 mb-5 flex flex-col gap-4 sm:flex-row sm:justify-center">

          <Link
href="/product/flashback/start"            className="inline-flex items-center justify-center rounded-full bg-[#E8C547] px-8 py-3 font-semibold text-black transition-colors hover:bg-[#d4b33d]"
          >
            Create Another Film
          </Link>
        </div>
